  ...
  return (
    <section id="about" className="grid grid-cols-1 md:grid-cols-2 gap-0 py-20 px-10">
      <div className="glass-card p-12 flex flex-col justify-center">
        ...
        <h2 className="text-4xl serif mb-6 leading-snug">Where Tradition Meets <br /> Modern Trust</h2>
      ...
      <div className="bg-zinc-200 h-96 md:h-auto relative overflow-hidden">
        <img src="/Images/home_story.jpg" alt="Artisanship" className="absolute inset-0 w-full h-full object-cover grayscale hover:grayscale-0 transition duration-1000" />
      </div>
    </section>
  );
}
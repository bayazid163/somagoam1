...
export default function Food() {
    const sections = [
    {
      ...
      items: [
        { name: "Traditional Roshmalai", region: "Cumilla", img: roshmalai, badge: "LAB VERIFIED", price: "৳ 650 / kg", desc: "Ancient 'khira' reduction method. 100% pure cow milk." },
        { name: "Bogura Mishti Doi", region: "Bogura", img: bograrDahi, badge: "PURITY TESTED", price: "৳ 350 / Pot", desc: "Fermented in traditional clay pots for unique aroma." },
        { name: "Porabari Chomchom", region: "Tangail", img: chomchom, badge: "AUTHENTIC", price: "৳ 700 / kg", desc: "Famous 'King of Sweets' made with Dhaleshwari river water." },
        { name: "Premium Cow Ghee", region: "Pabna", img: ghee, badge: "100% PURE", price: "৳ 1750 / kg", desc: "Hand-churned ghee with rich granular texture." },
      ]
    }, 
    {
      ...
      items: [
        { name: "Fresh Bhapa Pitha", region: "Sylhet", img: bhapa, badge: "FRESH MADE", price: "৳ 50", desc: "Steamed rice cakes with liquid jaggery and coconut." },
        { name: "Patisapta Pitha", region: "Dhaka", img: patishapta, badge: "NO PRESERVATIVES", price: "৳ 150", desc: "Thin rice-flour crepes with luscious Kheer filling." },
        { name: "Traditional Payesh", region: "Munshiganj", img: payesh, badge: "PURE MILK", price: "৳ 200", desc: "Slow-cooked rice pudding using Gobindobhog rice." },
        { name: "Chitoi Pitha", region: "Chattogram", img: chitoi, badge: "AUTHENTIC", price: "৳ 100", desc: "Fluffy steamed cakes served with spicy bhortas." },
      ]
    }, 
    {
        title: "Fresh Produce",
        ...
        items: [
          { name: "Padma Ilish", region: "Padma River", img: ilish, badge: "GI CERTIFIED", price: "৳ 1200 / kg", desc: "The iconic Hilsa fish with unique flavor from Padma." },
          { name: "Himsagar Pitha", region: "Rajshahi", img: himsagar, badge: "TRADITIONAL RECIPE", price: "৳ 80", desc: "Dense, sweet pitha soaked in thickened milk." },
          { name: "Sylhet Shatkora Pickle", region: "Sylhet", img: shatkora, badge: "HANDMADE", price: "৳ 250 / jar", desc: "Tangy citrus pickle made with local shatkora fruit." }
        ]
    }, 
    {
        ...
        items: [
            { name: "Khejur Gur (Date Jaggery)", region: "Khulna", img: gur, badge: "100% NATURAL", price: "৳ 300 / kg", desc: "Unrefined jaggery made from date palm sap." },
            { name: "Mixed Achar (Pickle)", region: "Chattogram", img: achar, badge: "GI CERTIFIED", price: "৳ 150 / jar", desc: "Spicy mixed vegetable pickle with traditional spices." },
            { name: "Shutki (Dried Fish)", region: "Chattogram", img: shutki, badge: "AUTHENTIC", price: "৳ 500 / kg", desc: "Sun-dried fish with intense flavor, a regional delicacy." },
            { name: "Mustard Oil", region: "Rangpur", img: mustardOil, badge: "GI CERTIFIED", price: "৳ 400 / liter", desc: "Cold-pressed mustard oil with strong aroma and flavor." },
        ]
    } 
  ];
  ...
  return (
    <div className="bg-[#F9F7F2]">
      ...
      <header className="px-10 py-20 text-center">
        <span className="brand-color text-xs uppercase tracking-[0.4em] mb-4 block">The Taste of Tradition</span>
        ...
        <main key={sIdx} className="px-10 py-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {section.items.map((item, iIdx) => (
              <div key={iIdx} className="food-card bg-white border border-stone-100 hover:border-[#A33B26] transition-all duration-300">
                ...
                <div className="p-6 flex flex-col">
                  ...
                  <div className="pt-4 mt-4 border-t border-stone-100 flex justify-between items-center">
                    ...
                    <button className="brand-color text-[10px] font-bold uppercase tracking-widest">Order</button>
                  </div>
                </div>
              </div>
            ))}
